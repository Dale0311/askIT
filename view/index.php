        ...
        <div class="lg:col-span-2 mt-5 space-y-4">
            <form>
                <div class="flex space-x-2 py-2 border-b border-t">
                    <a href="/notifications" class="block shrink-0">
                        <img alt="Speaker" src="img/1.jpg" class="h-10 w-10 rounded-full object-cover" />
                    </a>
            ...
            <article class="rounded-xl border-2 border-gray-100 bg-white hover:bg-gray-100 cursor-pointer">
                <div class="flex items-start gap-4 p-4 cursor-pointer">
                    ...
                    <div>
                        <a href="#" class="block shrink-0">
                            <p class="text-sm text-gray-500"><span class="font-semibold text-base text-gray-700">Dale Cabarle</span> @Arteezy_king</p>
                        </a>
                        <p class="line-clamp-2 text-sm text-gray-700">
                           How to integrate Tailwindcss into my React App project?
                        </p>
                        <div class="mt-2 sm:flex sm:items-center sm:gap-2">
                            <div class="flex items-center gap-1 text-gray-500">
                                ...
                                <p class="text-xs">14,180 comments</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <article class="rounded-xl border-2 border-gray-100 bg-white hover:bg-gray-100 cursor-pointer">
                <div class="flex items-start gap-4 p-4 cursor-pointer">
                    ...
                    <div>
                        ...
                        <p class="line-clamp-2 text-sm text-gray-700">
                           What are the modern tech stack for web development this 2023?
                        </p>
                        <div class="mt-2 sm:flex sm:items-center sm:gap-2">
                            <div class="flex items-center gap-1 text-gray-500">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <div class="flex items-start gap-4 p-4 cursor-pointer">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-700">
                           Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum quam ipsum sit. Minus voluptates porro corporis repudiandae, placeat assumenda officiis pariatur qui magnam eaque esse culpa veritatis laudantium natus voluptatum repellendus quidem accusamus corrupti, dolor ratione tempore, nobis ullam. Tenetur quasi beatae aliquid voluptatum necessitatibus ipsum libero nihil incidunt vel, illum sed. Iure laboriosam aperiam quas voluptatum, nam dolore eligendi possimus natus est, ut officia distinctio, tempora cupiditate temporibus sint. Doloremque, iste dolore debitis nobis hic, ratione tenetur qui animi quasi itaque dolor explicabo expedita ipsum suscipit accusamus numquam sapiente fuga quisquam facilis corrupti porro voluptatem ipsa soluta rem. Harum!
                        </p>
                        <div class="mt-2 sm:flex sm:items-center sm:gap-2">
                            <div class="flex items-center gap-1 text-gray-500">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
